                ...
                <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 shadow-xl">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <button
                                type="button"
                                className="w-full py-3 px-4 border border-gray-300 rounded-xl bg-white text-gray-700 hover:bg-gray-50 font-medium transition-all duration-300 flex items-center justify-center gap-2"
                            >
